...
//    public ArrayList<Contacts> getListObject(String key, Class<Contacts> mClass) {
//        Gson gson = new Gson();
//
...
//            Contacts value = gson.fromJson(jObjString, mClass);
//            objects.add(value);
//        }
//        return objects;
//    }
...
//    public boolean checkObjectNull(String key, Class<UserAddressObj> classOfT) {
//
//        String json = getString(key);
//        Object value = new Gson().fromJson(json, classOfT);
//        if (value == null) {
...
//    public void putChannelsListObject(String key, ArrayList<ChannelObj> objArray) {
//        checkForNullKey(key);
//        Gson gson = new Gson();
